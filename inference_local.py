...
import time
from TrashDataloader import val_transform
...
class ImageClassificationService():
    def __init__(self, model_name, model_path):
        ...
        self.model_name_sub = 'efficientnet-b7'
        ...
        # self.transforms = transforms.Compose([transforms.Resize(self.image_size, interpolation=Image.BICUBIC),
        ...
        #         "53": "美食/金线油塔"
        #     }
        with open('./train_classes.txt', 'r', encoding='utf-8') as f:
            for i, line in enumerate(f.readlines()):
                self.label_id_name_dict[str(i)] = line.strip()
...
def infer_on_dataset(img_dir, label_dir, model_path):
    ...
    print('initil time:', time.time()-s1)
    ...
    for file_name in files:
        ...
        s4 = time.time()
        print('transform time:', s4-s3)
        result = infer._inference({"input_img": img})
        print('eval time:', time.time()-s4)
    ...
    print('avg time:', (time.time())/len(files))
...
if __name__ == '__main__':
    img_dir = r'C:\Users\edwardning\Desktop\test'
    label_dir = r'C:\Users\edwardning\Desktop\test'
    model_path = r'C:\Users\edwardning\Desktop\epoch_50_100.0.pth'
    model_2 = r'C:\Users\edwardning\Desktop\epoch_40_65.217.pth'
